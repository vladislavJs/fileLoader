...
function upload(select) {
  ...
  var buttonOpen = element('button', ['btn'], 'Open');
  var buttonUpload = element('button', ['btn', 'primary'], 'Load');
...
},{"./upload":"upload.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
